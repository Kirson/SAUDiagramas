...
function initWireframeDiagram() {
	...
	if (stateIndex != -1) {
		...
		var lStateTitleText = document.getElementById("pageTitleText"+stateId).getAttribute("data-value");
		
		okWireframeStatesDialog(lStateSelectShapeId, lStateImageId, lStateDescriptionId, lStateElementsId, lPageTitleId, lStateTitleText);
	}
	else {
		
		var lDefaultStateTitleText = document.getElementById("defaultPageTitleText").getAttribute("data-value");
		
		okWireframeStatesDialog(lDefaultStateSelectShapeId, lDefaultStateImageId, lDefaultStateDescriptionId, lDefaultStateElementsId, lPageTitleId, lDefaultStateTitleText);
	}
...
function okWireframeStatesDialog(stateSelectShapeId, stateImageId, stateDescriptionId, stateElementsId, pageTitleId, stateTitleText, pageDescriptionId) {
